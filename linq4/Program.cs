...
namespace Curso
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var r3 = from p in products where p.Name[0] == 'C' select new { p.Name, p.Price, Categoria = p.Category.Name };
            ...
            var r7 = (from p in products where p.Price > 3000.0 select p).FirstOrDefault(); Console.WriteLine("FIRST TEST2:" + r7);
            ...
            Console.WriteLine("Category 1 Avarage price: " + r13);
            ...
            Console.WriteLine("Category 1 Average Sum: " + r15);
